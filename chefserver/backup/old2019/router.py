...
from chefserver.webhandler.publish import PushRecipeHandler, PushDongtaiHandler, EditRecipesubmitHandler
...
from chefserver.webhandler.dongtaiplaza import DtPlazaHandler, DtPlazafocusHandler

from chefserver.webhandler.index import IndexBannerHandler, IndexRecomTopicHandler, IndexRecomRecipeHandler, IndexFeaturedRecipeHandler
...
def make_app():
    return tornado.web.Application([
        ...
        (r"/publish/dongtai", PushDongtaiHandler),               # 发布动态
        ...
        (r"/dongtai/news", DtPlazaHandler),                      # 最新最热动态
        (r"/dongtai/follownews", DtPlazafocusHandler),           # 关注的最新动态
