...
from chefserver.config import ALIYUN_SMS_ID,ALIYUN_SMS_KEY_SECRET,ALIYUN_SMS_APP_SIGNNAME
...
if __name__ == '__main__':
    ...
    print(sms.get_signature_url("13950126971", 'SMS_172882935', {"code": 123456}))
